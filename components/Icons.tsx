...
export const Icons = {
  ...
  megamind: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2a5.5 5.5 0 0 1 5.5 5.5c0 2.25-1.125 4.25-2.5 5.5-1.5 1.25-2.5 3-2.5 4.5v.5a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-.5c0-1.5-1-3.25-2.5-4.5-1.375-1.25-2.5-3.25-2.5-5.5A5.5 5.5 0 0 1 12 2Z"/></svg>
  ),
  brainCircuit: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2a5.5 5.5 0 0 1 5.5 5.5c0 1 .25 2 .75 3s.75 2 .75 3-1 2.25-2.5 3.5C15 18.25 14 20 14 21.5v.5a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-.5c0-1.5-1-3.25-2.5-4.5C6 15.25 5 13.5 5 12s.25-2 .75-3 1-2.25 1.75-3.25"/><path d="M12 10.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/><path d="M4.5 10.5h-2"/><path d="M10 2.75v-2"/><path d="M14 2.75v-2"/><path d="M4.5 13.5h-2"/><path d="M19.5 10.5h2"/><path d="M19.5 13.5h2"/><path d="M10 21.25v2"/><path d="M14 21.25v2"/></svg>
  ),
  user: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
  ),
  panelLeftClose: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="18" height="18" x="3" y="3" rx="2"/><path d="m9 3-3 9 3 9"/><path d="m15 9-3 3 3 3"/></svg>
  ),
  panelRightClose: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="18" height="18" x="3" y="3" rx="2"/><path d="m15 3 3 9-3 9"/><path d="m9 9 3 3-3 3"/></svg>
  ),
  ...
  timer: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><line x1="10" x2="14" y1="2" y2="2"/><line x1="12" x2="12" y1="14" y2="22"/><path d="M18.37 7.63A9 9 0 1 0 5.63 18.37"/><path d="M12 8v4l2 2"/></svg>
  ),
  ...
  loader: (props: IconProps) => (
   ...
   swords: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14.5 17.5 3 6V3h3l11.5 11.5"/><path d="m21 3-3.5 3.5"/><path d="M14.5 3 3 14.5V21h6.5L21 9.5Z"/></svg>
  ),
  areaChart: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 3v18h18"/><path d="M7 12v5h12V8l-5 5-4-4Z"/></svg>
  ),
  ...
  laptop: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M20 16V7a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v9m16 0H4m16 0 1.28 2.55A1 1 0 0 1 20.7 20H3.3a1 1 0 0 1-.58-1.45L4 16"/></svg>
  ),
  ...
  piggyBank: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M10 17V15"/><path d="M14 17V15"/><path d="M2 12.5C2 9 5.5 6 10 6c.7 0 1.4.1 2 .2 1.5.4 3 1 4.5 2.5l-2.1 2.2c-.4.4-.4 1 .1 1.4 1 .8 2.5 2.5 2.5 2.5s-2 2-4.5 2H11c-2.5 0-4.5-2-4.5-4.5 0-.7.1-1.4.4-2"/><path d="M18.8 8.4C19.4 8 20.2 8 21 8.5c.8.4 1 1.2.8 2l-2.6 7.4c-.2.7-.9 1.1-1.6.9l-7.3-2.5c-.7-.2-1.1-.9-.9-1.6l2.6-7.4c.3-.7 1-1.1 1.6-.9Z"/></svg>
  ),
};